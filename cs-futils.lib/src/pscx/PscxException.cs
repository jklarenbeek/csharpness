...
namespace joham.cs_futils.pscx
{
    ...
    public static class PscxArgumentException
    {
        ...
        {
            return new ArgumentException(String.Format(CultureInfo.CurrentUICulture, Errors.ObjectMustBeOfType, requiredType.FullName), paramName);
        }
    }
